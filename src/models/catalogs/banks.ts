...
export default class BankModel {
    ...
    public async validate(): Promise<any> {
        return this.validateSchemas(this.bank);
    }

    private async validateSchemas(_bank: any = {}): Promise<any> {
        
        let errors: Array<any> = [];
        
        let bank = new Bank();
        bank.name = _bank.name;
        bank.value = _bank.value;
        let bankErrors = await validate(bank, { skipMissingProperties: true });
        errors = RemodelErrors(bankErrors, 'bank');
    ...
    public getBank(query: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            axios.get(configuration.services.domain.finance.payments.bank.getBank, { params: query })
            .then((response: any) => {
    ...
    public getBanks(query: any): Promise<any> {
        // Parámetros.
        ...
        // Petición.
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            axios.get(configuration.services.domain.finance.payments.bank.getBanks, { params })
            .then((response: any) => {
                return resolve(idx(response, _ => _.data) || []);
            })
            .catch((error: any) => {
    ...
    public postBank(body: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            let errors: Array<any> = [];
            ...
            if(errors.length > 0) {
                ...
                axios.post(configuration.services.domain.finance.payments.bank.postBank, body)
                .then((response: any) => {
                    return resolve(idx(response, _ => _.data) || {});
                })
                .catch((error: any) => {
                    if(typeof error.code === 'string' && error.code === 'ECONNREFUSED') {
                        ...
                        return reject({
                            status: 400,
                            module: 'Bancos',
                            message: 'Ocurrió un error al intentar guardar la información (BANCO).',
                            error: idx(error, _ => _.response.data) || error
                        });
                    }
                });
    ...
    public putBank(body: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            let errors: Array<any> = [];
            this.validateSchemas(body)
            .then((data: any) => {
            ...
            if(errors.length > 0) {
                ...
                axios.put(configuration.services.domain.finance.payments.bank.putBank, body)
                .then((response: any) => {
                    return resolve(idx(response, _ => _.data) || {});
                })
                .catch((error: any) => {
    ...
    public deleteBank(query: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            axios.delete(configuration.services.domain.finance.payments.bank.deleteBank, { params: query })
            .then((response: any) => {
                return resolve(idx(response, _ => _.data) || {});
            })
            .catch((error: any) => {
