...
export default class UserStatusModel {
    ...
    constructor(userStatus?: UserStatus) {
        this.userStatus = userStatus || new UserStatus();    
    }
    ...
    public async validate(): Promise<any> {
        return this.validateSchemas(this.userStatus);
    }

    private async validateSchemas(_userStatus: any = {}): Promise<any> {
        
        let errors: Array<any> = [];
        
        let userStatus = new UserStatus();
        userStatus.name = _userStatus.name;
        userStatus.value = _userStatus.value;
        let userStatusErrors = await validate(userStatus, { skipMissingProperties: true });
        errors = RemodelErrors(userStatusErrors, 'userStatus');
    ...
    public getUserStatus(query: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            axios.get(configuration.services.domain.users.status.getStatus, { params: query })
            .then((response: any) => {
    ...
    public getUserStatuses(query: any): Promise<any> {
        // Parámetros.
        ...
        // Petición.
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            axios.get(configuration.services.domain.users.status.getStatuses, { params })
            .then((response: any) => {
                return resolve(idx(response, _ => _.data) || []);
            })
            .catch((error: any) => {
    ...
    public postUserStatus(body: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            let errors: Array<any> = [];
            ...
            if(errors.length > 0) {
                ...
                axios.post(configuration.services.domain.users.status.postStatus, body)
                .then((response: any) => {
                    return resolve(idx(response, _ => _.data) || {});
                })
                .catch((error: any) => {
    ...
    public putUserStatus(body: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            let errors: Array<any> = [];
            this.validateSchemas(body)
            .then((data: any) => {
            ...
            if(errors.length > 0) {
                ...
                axios.put(configuration.services.domain.users.status.putStatus, body)
                .then((response: any) => {
                    return resolve(idx(response, _ => _.data) || {});
                })
                .catch((error: any) => {
    ...
    public deleteUserStatus(query: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            axios.delete(configuration.services.domain.users.status.deleteStatus, { params: query })
            .then((response: any) => {
                return resolve(idx(response, _ => _.data) || {});
            })
            .catch((error: any) => {
