...
export default class ReceiptTypeModel {

    //Propiedades.
    private receiptType: any;

    //Constructor.
    constructor(receiptType?: any) {
    ...
    public async validate(): Promise<any> {
        return this.validateSchemas(this.receiptType);
    }

    private async validateSchemas(_receiptType: any = {}): Promise<any> {
        
        let errors: Array<any> = [];
        
        let receiptType = new ReceiptType();
        receiptType.name = _receiptType.name;
        receiptType.value = _receiptType.value;
        let receiptTypeErrors = await validate(receiptType, { skipMissingProperties: true });
        errors = RemodelErrors(receiptTypeErrors, 'receiptType');
    ...
    public getReceiptType(query: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            axios.get(configuration.services.domain.finance.receipts.types.getType, { params: query })
            .then((response: any) => {
    ...
    public getReceiptTypes(query: any): Promise<any> {
        // Parámetros.
        ...
        // Petición.
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            axios.get(configuration.services.domain.finance.receipts.types.getTypes, { params })
            .then((response: any) => {
                return resolve(idx(response, _ => _.data) || []);
            })
            .catch((error: any) => {
    ...
    public postReceiptType(body: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            let errors: Array<any> = [];
            ...
            if(errors.length > 0) {
                ...
                axios.post(configuration.services.domain.finance.receipts.types.postType, body)
                .then((response: any) => {
                    return resolve(idx(response, _ => _.data) || {});
                })
                .catch((error: any) => {
    ...
    public putReceiptType(body: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            let errors: Array<any> = [];
            this.validateSchemas(body)
            .then((data: any) => {
            ...
            if(errors.length > 0) {
                ...
                axios.put(configuration.services.domain.finance.receipts.types.putType, body)
                .then((response: any) => {
                    return resolve(idx(response, _ => _.data) || {});
                })
                .catch((error: any) => {
    ...
    public deleteReceiptType(query: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            axios.delete(configuration.services.domain.finance.receipts.types.deleteType, { params: query })
            .then((response: any) => {
                return resolve(idx(response, _ => _.data) || {});
            })
            .catch((error: any) => {
