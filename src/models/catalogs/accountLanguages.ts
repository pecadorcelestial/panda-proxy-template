...
export default class AccountLanguageModel {

    //Propiedades.
    private accountLanguage: any;

    //Constructor.
    constructor(accountLanguage?: any) {
    ...
    public async validate(): Promise<any> {
        return this.validateSchemas(this.accountLanguage);
    }

    private async validateSchemas(_accountLanguage: any = {}): Promise<any> {
        
        let errors: Array<any> = [];
        
        let accountLanguage = new AccountLanguage();
        accountLanguage.name = _accountLanguage.name;
        accountLanguage.value = _accountLanguage.value;
        let accountLanguageErrors = await validate(accountLanguage, { skipMissingProperties: true });
        errors = RemodelErrors(accountLanguageErrors, 'accountLanguage');
    ...
    public getAccountLanguage(query: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            axios.get(configuration.services.domain.accounts.language.getLanguage, { params: query })
            .then((response: any) => {
    ...
    public getAccountLanguagees(query: any): Promise<any> {
        // Parámetros.
        ...
        // Petición.
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            axios.get(configuration.services.domain.accounts.language.getLanguages, { params })
            .then((response: any) => {
                return resolve(idx(response, _ => _.data) || []);
            })
            .catch((error: any) => {
    ...
    public postAccountLanguage(body: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            let errors: Array<any> = [];
            ...
            if(errors.length > 0) {
                ...
                axios.post(configuration.services.domain.accounts.language.postLanguage, body)
                .then((response: any) => {
                    return resolve(idx(response, _ => _.data) || {});
                })
                .catch((error: any) => {
    ...
    public putAccountLanguage(body: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            let errors: Array<any> = [];
            this.validateSchemas(body)
            .then((data: any) => {
            ...
            if(errors.length > 0) {
                ...
                axios.put(configuration.services.domain.accounts.language.putLanguage, body)
                .then((response: any) => {
                    return resolve(idx(response, _ => _.data) || {});
                })
                .catch((error: any) => {
    ...
    public deleteAccountLanguage(query: any): Promise<any> {
        return new Promise((resolve: (value?: {} | PromiseLike<{}> | undefined) => void, reject: (reason?: any) => void) => {
            axios.delete(configuration.services.domain.accounts.language.deleteLanguage, { params: query })
            .then((response: any) => {
                return resolve(idx(response, _ => _.data) || {});
            })
            .catch((error: any) => {
